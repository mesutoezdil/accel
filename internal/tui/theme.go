...
var Roles = []string{
	"accent", "text", "dim", "title", "border", "bg",
...
var palettes = map[string]map[string]string{
	"default": {
		"accent": "12", "text": "", "dim": "8", "title": "12", "border": "8", "bg": "#0d1117",
	...
	"mono": {
		"accent": "", "text": "", "dim": "8", "title": "", "border": "8", "bg": "#0d1117",
		"ok": "", "mid": "", "warn": "", "crit": "", "info": "",
		"bar_low": "", "bar_mid": "", "bar_high": "", "bar_track": "8", "spark": "",
		"tab_active_bg": "", "tab_active_fg": "", "selection_bg": "8", "selection_fg": "15",
	},
	"solarized": {
		"accent": "#268bd2", "text": "#839496", "dim": "#586e75", "title": "#268bd2", "border": "#586e75", "bg": "#002b36",
	...
	"dracula": {
		"accent": "#bd93f9", "text": "#f8f8f2", "dim": "#6272a4", "title": "#bd93f9", "border": "#6272a4", "bg": "#282a36",
	...
	"amber": {
		"accent": "214", "text": "223", "dim": "137", "title": "214", "border": "137", "bg": "#1a1300",
	...
	"nord": {
		"accent": "#88c0d0", "text": "#d8dee9", "dim": "#4c566a", "title": "#88c0d0", "border": "#4c566a", "bg": "#2e3440",
	...
	"gruvbox": {
		"accent": "#83a598", "text": "#ebdbb2", "dim": "#928374", "title": "#fabd2f", "border": "#504945", "bg": "#282828",
	...
	"catppuccin": {
		"accent": "#cba6f7", "text": "#cdd6f4", "dim": "#6c7086", "title": "#cba6f7", "border": "#45475a", "bg": "#1e1e2e",
	...
	"tokyo-night": {
		"accent": "#7aa2f7", "text": "#c0caf5", "dim": "#565f89", "title": "#7aa2f7", "border": "#3b4261", "bg": "#1a1b26",
	...
	"one-dark": {
		"accent": "#61afef", "text": "#abb2bf", "dim": "#5c6370", "title": "#61afef", "border": "#4b5263", "bg": "#282c34",
	...
	"rose-pine": {
		"accent": "#c4a7e7", "text": "#e0def4", "dim": "#6e6a86", "title": "#c4a7e7", "border": "#403d52", "bg": "#191724",
	...
	"monokai": {
		"accent": "#66d9ef", "text": "#f8f8f2", "dim": "#75715e", "title": "#66d9ef", "border": "#49483e", "bg": "#272822",
	...
	"flexoki": {
		"accent": "#4385be", "text": "#cecdc3", "dim": "#878580", "title": "#4385be", "border": "#403e3c", "bg": "#100f0f",
	...
	"ice": {
		"accent": "39", "text": "153", "dim": "67", "title": "39", "border": "67", "bg": "#0b1622",
